...
JHTML::_('script', 'administrator/components/COM_PRAYER/assets/js/admin_pc.js');
    ...
    <div class="well well-small" style="color:#08c;font-size:small;">
        ...
        <div class="row-striped">
            <div class="row-fluid small">
                ...
                <div class="span3" style="white-space:nowrap;">
					<?php
					$url    = "http://www.mlwebtechnologies.com/update/prayer-update.xml";
            ...
            <div class="row-fluid small">
                ...
                <div class="span3" style="white-space:nowrap;">
                    <a href="http://www.gnu.org/copyleft/gpl.html" target="_blank"><img
                                src="<?php echo JURI::base(); ?>components/COM_PRAYER/assets/images/gplv3-88x31.png"
            ...
            <div class="row-fluid small">
                ...
                <div class="row-fluid small">
                    ...
                    <div class="span3">
                        ...
                        <input type="hidden" name="item_name" value="MLWebTechnologies - prayer Donations"/>
                        ...
                        <input type="image"
                               src="<?php echo JURI::base(); ?>components/COM_PRAYER/assets/images/donate.gif"
            ...
            <div class="row-striped">
				...
				foreach ($modArray as $module)
				{
					...
					if ($xmldata)
					{
                        ...
                        <div class="row-fluid small">
                            <div class="span12">
                                <div class="span6"><i class="icon-cube"></i> <span><?php echo $module['name']; ?></span>
                                </div>
                                <div class="span4 right nowrap"><span
                                            style="color:green;font-weight:bold;"><?php echo JText:: _('Installed'); ?>
                                        ( v.<?php echo $xmldata['version']; ?> - <?php echo $xmldata['creationDate']; ?>
                                        )</span></div>
                                <div class="span2 center"><font
        ...
        <script language="javascript">
			function printconfig() {
				...
				docprint.document.write('<html><head><title>prayer Configuration File</title>');
        ...
        <div class="well well-small">
            ...
            <div class="row-striped">
                ...
                <div class="row-fluid">
                    <div class="span12"><a
                                href="<?php echo JURI::base(); ?>index.php?option=com_prayer&task=utilities"><i
                                    class="icon-tools"></i> <span><?php echo JText::_('Component Utilities'); ?></span></a>
                    </div>
                </div>
                <div class="row-fluid">
                    <div class="span12"><a href="#" onclick="printconfig();"><i class="icon-print"></i>
                            <span><?php echo JText::_('Print Configuration'); ?></span></a></div>
                </div>
                <div class="row-fluid">
                    <div class="span12"><a href="#" onclick="savePCConfig2file();"><i class="icon-file"></i>
                            <span><?php echo JText::_('Save Configuration to File'); ?></span></a></div>
                </div>
				<?php
				$url    = "http://www.mlwebtechnologies.com/update/prayer-update.xml";
				$data   = file_get_contents($url);
                ...
                <div class="row-fluid" id="plg_quickicon_extensionupdate">
                    <div class="span12"><a href="<?php echo JURI::base(); ?>index.php?option=com_installer&view=update"><i
                                    class="icon-asterisk"></i> <span><?php echo $message; ?></span></a></div>
                </div>
                <div class="row-fluid">
                    <div class="span12"><a href="<?php echo JURI::base(); ?>index.php?option=com_admin&view=sysinfo"><i
                                    class="icon-question-sign"></i>
                            <span><?php echo JText::_('System Information'); ?></span></a></div>
                </div>
                <div class="row-fluid">
                    <div class="span12"><a href="<?php echo JURI::base(); ?>index.php"><i class="icon-dashboard"></i>
