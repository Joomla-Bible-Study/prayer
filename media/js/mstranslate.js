function getTranslator() {
	...
	window.mycallback = function (response) {
		document.getElementById("pcrequest").innerHTML = response;
	}
...
function getTranslator2(reqid, site) {
	...
	var requesturl = site + '/index.php?option=com_cwmprayer&task=view_request&id=' + reqid + '&pop=1&tmpl=component';
